...
public class BasePage {
  ...
  /*  protected void uploadMultipleFiles(WebDriver driver, String... fileNames) {
        ...
        for(String fileName : fileNames) {
            ...
            *//*fileNamePath = folderUploadFilePath + fileName + "\n";*//*
        }
        fileNamePath = new StringBuilder(fileNamePath.toString().trim());
        getWebElement(driver, BasePageUI.UPLOAD_FILE).sendKeys(fileNamePath);
    }*/

    /* ------------------------------------------------------------------Wait------------------------------------------------------------------*/

    protected void waitForElementVisible(WebDriver driver, String locatorType) {
        new WebDriverWait(driver, GlobalConstants.LONG_TIME_OUT).until(ExpectedConditions.visibilityOfElementLocated(getLocator(locatorType)));
    }

    protected void waitForElementVisible(WebDriver driver, String locatorType, String... dynamicValues) {
        new WebDriverWait(driver, GlobalConstants.LONG_TIME_OUT).until(ExpectedConditions.visibilityOfElementLocated(getLocator(getDynamicXpath(locatorType, dynamicValues))));
    }

    protected void waitForAllElementVisible(WebDriver driver, String locatorType) {
        new WebDriverWait(driver, GlobalConstants.LONG_TIME_OUT).until(ExpectedConditions.visibilityOfAllElementsLocatedBy(getLocator(locatorType)));
    }

    protected void waitForAllElementVisible(WebDriver driver, String locatorType, String... dynamicValues) {
        new WebDriverWait(driver, GlobalConstants.LONG_TIME_OUT).until(ExpectedConditions.visibilityOfAllElementsLocatedBy(getLocator(getDynamicXpath(locatorType, dynamicValues))));
    }

    protected void waitForElementInvisible(WebDriver driver, String locatorType) {
        new WebDriverWait(driver, GlobalConstants.LONG_TIME_OUT).until(ExpectedConditions.invisibilityOfElementLocated(getLocator(locatorType)));
    }

    protected void waitForElementInvisible(WebDriver driver, String locatorType, String... dynamicValues) {
        new WebDriverWait(driver, GlobalConstants.LONG_TIME_OUT).until(ExpectedConditions.invisibilityOfElementLocated(getLocator(getDynamicXpath(locatorType, dynamicValues))));
    }

    protected void waitForAllElementInvisible(WebDriver driver, String locatorType) {
        new WebDriverWait(driver, GlobalConstants.LONG_TIME_OUT).until(ExpectedConditions.invisibilityOfAllElements(getListWebElements(driver, locatorType)));
    }

    protected void waitForAllElementInvisible(WebDriver driver, String locatorType, String... dynamicValues) {
        new WebDriverWait(driver, GlobalConstants.LONG_TIME_OUT).until(ExpectedConditions.invisibilityOfAllElements(getListWebElements(driver, getDynamicXpath(locatorType, dynamicValues))));
    }

    protected void waitForElementClickable(WebDriver driver, String locatorType) {
        new WebDriverWait(driver, GlobalConstants.LONG_TIME_OUT).until(ExpectedConditions.elementToBeClickable(getLocator(locatorType)));
    }

    protected void waitForElementClickable(WebDriver driver, String locatorType, String... dynamicValues) {
        new WebDriverWait(driver, GlobalConstants.LONG_TIME_OUT).until(ExpectedConditions.elementToBeClickable(getLocator(getDynamicXpath(locatorType, dynamicValues))));
    }
    ...
    protected boolean areJQueryAndJSLoadedSuccess(WebDriver driver) {
        WebDriverWait explicitWait = new WebDriverWait(driver, GlobalConstants.LONG_TIME_OUT);
        //jsExecutor = (JavascriptExecutor) driver;
    ...
    public void clickToDynamicPageListLink(WebDriver driver, String pageListName) {
        waitForElementClickable(driver, BasePageUI.DYNAMIC_PAGE_LIST_LINK, pageListName);
        clickToElement(driver, BasePageUI.DYNAMIC_PAGE_LIST_LINK, pageListName);
    }
}
