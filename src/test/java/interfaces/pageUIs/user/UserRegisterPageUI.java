...
public class UserRegisterPageUI {
    ...
    public static final String DYNAMIC_FIELD = "xpath=//input[@id='%s']";
    public static final String DYNAMIC_GENDER = "xpath=//span[@class='%s']/child::input";
    public static final String DYNAMIC_DATE_OF_BIRTH = "xpath=//div[@class='date-picker-wrapper']/child::select[@name='%s']";
